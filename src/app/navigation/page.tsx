...
export default function NavigationPage() {
  ...
  const transports = [
    { id: 1, name: 'Команда EVA Альфа', from: 'module', to: 'lab', eta: '5 мин' },
    { id: 2, name: 'Грузовой транспорт 2', from: 'launch', to: 'storage', eta: '12 мин' },
    { id: 3, name: 'Авто техобслуживания 5', from: 'storage', to: 'power', eta: '8 мин' },
  ];
      ...
      <div className="flex flex-col lg:flex-row gap-6">
            ...
            {transports.map(t => {
              ...
              return (
                <line key={t.id} x1={x1} y1={y1} x2={x2} y2={y2}
                  stroke="blue" strokeWidth="0.5" strokeDasharray="2" markerEnd="url(#arrow)"/>
              );
            })}
          </svg>
        </div>
        ...
        <div className="w-full lg:w-1/3 bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <ul className="space-y-3">
            {transports.map(t=>(
              <li key={t.id} className="flex items-center justify-between p-3 bg-gray-50 rounded">
